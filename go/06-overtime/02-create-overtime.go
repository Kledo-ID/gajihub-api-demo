...
func main() {
	fmt.Println("=== Tambah Lembur ===")

	hasil := apiRequest("POST", "/hr/overtimes", nil, map[string]any{
		"hr_employee_id":         1,                                           // WAJIB: ID karyawan
		"date":                   tanggal(0),                                  // WAJIB: tanggal lembur (YYYY-MM-DD)
