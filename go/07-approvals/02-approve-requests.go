...
//
//	go run 02-approve-requests.go
//
// PERHATIAN: demo ini MENGUBAH status pengajuan di GajiHub Anda.
// ID pengajuan diambil dari demo 01-list-approvals.go
package main
...
func main() {
	fmt.Println("=== Setujui Pengajuan ===")

	idPengajuan := []int{0} // ganti dengan ID pengajuan, bisa lebih dari 1: []int{12, 13}

	// Untuk menolak, ganti endpoint menjadi /hr/approvals/decline
	hasil := apiRequest("PATCH", "/hr/approvals/approve", nil, map[string]any{
		"ids":         idPengajuan,
