...
func main() {
	fmt.Println("=== Detail Karyawan ===")

	idKaryawan := 1 // ganti dengan ID karyawan (lihat demo 01-list-employees.go)

	hasil := apiRequest("GET", fmt.Sprintf("/hr/employees/%d", idKaryawan), nil, nil)
