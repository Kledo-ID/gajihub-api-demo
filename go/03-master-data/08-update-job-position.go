...
//
//	go run 08-update-job-position.go
//
...
func main() {
	fmt.Println("=== Ubah Jabatan ===")

	idJabatan := 0 // ganti dengan ID jabatan (lihat hasil demo 07-create-job-position.go)

	hasil := apiRequest("PUT", fmt.Sprintf("/hr/jobPositions/%d", idJabatan), nil, map[string]any{
