...
//
//	go run 02-monthly-attendance-by-employee.go
//
// ID karyawan bisa dilihat dari demo "02-employees/01-list-employees.go".
package main
...
func main() {
	fmt.Println("=== Absensi Bulanan 1 Karyawan ===")

	hasil := apiRequest("GET", "/hr/attendances/pagination", url.Values{
