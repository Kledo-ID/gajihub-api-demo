...
//
//	go run 03-export-cash-advances.go
//
...
func main() {
	fmt.Println("=== Export Kasbon (Excel) ===")

	unduhFile("/hr/cashReceipt/balance/export/xls", nil) // saldo kasbon per karyawan
	unduhFile("/hr/cashReceipt/history/export/xls", nil) // riwayat pengajuan kasbon
}
