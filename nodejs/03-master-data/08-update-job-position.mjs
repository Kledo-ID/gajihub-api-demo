 ...
 *   node 08-update-job-position.mjs
 *
...
console.log('=== Ubah Jabatan ===');

const idJabatan = 0; // ganti dengan ID jabatan (lihat hasil demo 07-create-job-position.mjs)

const hasil = await apiRequest('PUT', '/hr/jobPositions/' + idJabatan, {
