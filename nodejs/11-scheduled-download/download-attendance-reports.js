 ...
 *   node download-attendance-reports.js                          -> laporan kemarin
 *   node download-attendance-reports.js 2026-09-01 2026-09-30    -> laporan rentang tanggal
 *
 ...
 *               0 6 * * * node /lokasi/gajihub-api-demo/nodejs/11-scheduled-download/download-attendance-reports.js
 */
...
async function unduhFile(endpoint, parameter = {}) {
    ...
    const folder = path.join(__dirname, 'hasil-unduhan');
