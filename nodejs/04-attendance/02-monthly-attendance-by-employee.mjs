 ...
 *   node 02-monthly-attendance-by-employee.mjs
 *
 * ID karyawan bisa dilihat dari demo "02-employees/01-list-employees.mjs".
 */
...
console.log('=== Absensi Bulanan 1 Karyawan ===');

const hasil = await apiRequest('GET', '/hr/attendances/pagination', {
