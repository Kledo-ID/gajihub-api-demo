 ...
 *   node 02-approve-requests.mjs
 *
 * PERHATIAN: demo ini MENGUBAH status pengajuan di GajiHub Anda.
 * ID pengajuan diambil dari demo 01-list-approvals.mjs
 */
...
console.log('=== Setujui Pengajuan ===');

const idPengajuan = [0]; // ganti dengan ID pengajuan, bisa lebih dari 1: [12, 13]

const hasil = await apiRequest('PATCH', '/hr/approvals/approve', { // untuk menolak, ganti menjadi /hr/approvals/decline
    ids: idPengajuan,
