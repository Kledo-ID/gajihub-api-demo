 ...
 *   node 02-create-annual-leave.mjs
 *
...
console.log('=== Tambah Cuti Tahunan ===');

const hasil = await apiRequest('POST', '/hr/leaves/annualLeaves', {
...
if (hasil.sukses) {
    console.log();
    console.log('ID cuti baru: ' + hasil.data.data.id);
}
