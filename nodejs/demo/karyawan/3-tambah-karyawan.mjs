 ...
 *
 * Jalankan lewat terminal:  node 3-tambah-karyawan.mjs
 *
...
const hasil = await apiPost('/hr/employees/insert', {
    ...
    personal: {
        ...
        hr_religion_id: 1,                              // lihat demo data-master/6-referensi.mjs
...
if (hasil.sukses) {
    tulis('');
    tulis('ID karyawan baru: ' + hasil.data.data.id);
}
