 ...
 *
 * Jalankan lewat terminal:  node 1-absensi-harian.mjs
 */

import { apiGet, mulaiDemo, tampilkan, tanggal, tulis } from '../../gajihub.mjs';

mulaiDemo('Absensi Harian Semua Karyawan');

const hasil = await apiGet('/hr/attendances/daily/pagination', {
