...
console.log('=== Detail Karyawan ===');

const idKaryawan = 1; // ganti dengan ID karyawan (lihat demo 01-list-employees.mjs)

const hasil = await apiRequest('GET', '/hr/employees/' + idKaryawan);
