...
Cara pakai (isi dulu API_HOST dan ACCESS_TOKEN di bagian Konfigurasi):
  python download-attendance-reports.py                          -> laporan kemarin
  python download-attendance-reports.py 2026-09-01 2026-09-30    -> laporan rentang tanggal
...
Agar berjalan otomatis setiap hari, jadwalkan perintah di atas:
  ...
  - Linux   : cron, contoh setiap jam 06:00:
              0 6 * * * python3 /lokasi/gajihub-api-demo/python/11-scheduled-download/download-attendance-reports.py
"""
...
def main():
    print('=== Unduh Otomatis Laporan Absensi ===')
    ...
    print(f'Periode: {tanggal_mulai} s/d {tanggal_selesai}')
