...
Cara pakai: isi API_HOST dan ACCESS_TOKEN di bagian Konfigurasi, lalu jalankan:
  python 09-delete-job-position.py
...
def main():
    ...
    id_jabatan = 0  # ganti dengan ID jabatan (lihat hasil demo 07-create-job-position.py)

    hasil = api_request('DELETE', f'/hr/jobPositions/{id_jabatan}')
