 ...
 *   php 09-delete-job-position.php
 *
...
echo '=== Hapus Jabatan ===' . PHP_EOL;

$idJabatan = 0; // ganti dengan ID jabatan (lihat hasil demo 07-create-job-position.php)

$hasil = api_request('DELETE', '/hr/jobPositions/' . $idJabatan);
