 ...
 *   php download-attendance-reports.php                          -> laporan kemarin
 *   php download-attendance-reports.php 2026-09-01 2026-09-30    -> laporan rentang tanggal
 *
 * File tersimpan di folder hasil-unduhan/ di sebelah file ini
 *
 * Agar berjalan otomatis setiap hari, jadwalkan perintah di atas:
 *   - Windows : Task Scheduler (lihat php/README.md)
 *   - Linux   : cron, contoh setiap jam 06:00:
 *               0 6 * * * php /lokasi/gajihub-api-demo/php/11-scheduled-download/download-attendance-reports.php
 */
...
echo '=== Unduh Otomatis Laporan Absensi ===' . PHP_EOL;
...
echo "Periode: {$tanggalMulai} s/d {$tanggalSelesai}" . PHP_EOL;
$periode = [
