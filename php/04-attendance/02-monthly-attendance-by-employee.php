 ...
 *   php 02-monthly-attendance-by-employee.php
 *
 * ID karyawan bisa dilihat dari demo "02-employees/01-list-employees.php".
 */
...
echo '=== Absensi Bulanan 1 Karyawan ===' . PHP_EOL;

$hasil = api_request('GET', '/hr/attendances/pagination', [
