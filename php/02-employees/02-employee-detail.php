...
echo '=== Detail Karyawan ===' . PHP_EOL;

$idKaryawan = 1; // ganti dengan ID karyawan (lihat demo 01-list-employees.php)

$hasil = api_request('GET', '/hr/employees/' . $idKaryawan);
