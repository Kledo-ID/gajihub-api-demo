 ...
 *   php 02-create-annual-leave.php
 *
...
echo '=== Tambah Cuti Tahunan ===' . PHP_EOL;

$hasil = api_request('POST', '/hr/leaves/annualLeaves', [
...
if ($hasil['sukses']) {
    echo PHP_EOL;
    echo 'ID cuti baru: ' . $hasil['data']['data']['id'] . PHP_EOL;
}
