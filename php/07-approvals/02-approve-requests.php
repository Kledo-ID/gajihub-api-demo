 ...
 *   php 02-approve-requests.php
 *
 * PERHATIAN: demo ini MENGUBAH status pengajuan di GajiHub Anda.
 * ID pengajuan diambil dari demo 01-list-approvals.php
 */
...
echo '=== Setujui Pengajuan ===' . PHP_EOL;

$idPengajuan = [0]; // ganti dengan ID pengajuan, bisa lebih dari 1: [12, 13]

$hasil = api_request('PATCH', '/hr/approvals/approve', [   // untuk menolak, ganti menjadi /hr/approvals/decline
    'ids'         => $idPengajuan,
